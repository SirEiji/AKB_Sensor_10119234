...
import com.example.akbsensor.databinding.FragmentTempat1Binding;
...
public class Lokasi1Fragment extends Fragment implements OnMapReadyCallback {

    private GoogleMap mMap;
    private FragmentTempat1Binding binding;

    public static Lokasi1Fragment newInstance() {
        return new Lokasi1Fragment();
    }
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        markers.add(googleMap.addMarker(new MarkerOptions()
                .position(new LatLng(-6.9052335, 107.6854509))
                .title("My Home")));
